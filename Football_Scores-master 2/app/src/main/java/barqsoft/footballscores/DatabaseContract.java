...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        public static final String HOME_ID_COL = "home_id";//For matching to crest file name.
        public static final String AWAY_ID_COL = "away_id";//For matching to crest file name.
